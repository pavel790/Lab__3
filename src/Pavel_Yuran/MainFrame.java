...
// По умолчанию пункт меню является недоступным (данных ещё нет)
        ...
        // Создать новое "действие" по сохранению в текстовый файл
        Action saveToGraphicsAction = new AbstractAction("Сохранить данные для построения графика(бинарный файл)") {
            public void actionPerformed(ActionEvent event) {
                if (fileChooser==null) {
...
// По умолчанию пункт меню является недоступным(данных ещѐ нет)
        ...
        // Создать новое "действие" по информации о программе
        Action aboutAction = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent event) {
// Показать диалоговое окно
                JOptionPane.showMessageDialog(MainFrame.this, "Автор:Юран Павел Васильевич, 10 группа");
            }
        };
